...
const HeroSection = ({ isOpenStatus, onScrollToMenu }) => {
  return (
    <section className="w-full min-h-[584px] px-5 pt-24 pb-16 flex flex-col justify-center items-center overflow-hidden">
      ...
      <button onClick={onScrollToMenu} className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-br from-fuchsia-700 to-purple-900 rounded-full shadow-[0px_0px_60px_0px_rgba(151,80,175,0.20),0px_0px_30px_0px_rgba(151,80,175,0.60),inset_0px_1px_0px_0px_rgba(255,255,255,0.15)] hover:scale-105 transition-transform duration-300">
      ...
      <div className="pt-16 opacity-40 flex flex-col items-center gap-1">
        <span className="text-xs font-normal text-gray-100 uppercase font-['Share_Tech_Mono'] leading-4 tracking-wider">scroll</span>
